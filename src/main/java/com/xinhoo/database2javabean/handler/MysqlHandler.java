 ...
 */
@Component
public class MysqlHandler extends AbsHandler {
    ...
    public Connection getConnection(DBConfig dbConfig) throws Exception{
        ...
        return DriverManager.getConnection(String.format("jdbc:mysql://%s:%d/%s",dbConfig.getIp(),dbConfig.getPort(),dbConfig.getName()), dbConfig.getUser_name(), dbConfig.getUser_pwd());
    }
}
